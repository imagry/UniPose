...
def plot_on_image(image_pil, tgt, keypoint_skeleton,keypoint_text_prompt,output_dir, output_file):
    ...
    ax.set_axis_off()
    savename = os.path.join(output_dir,output_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", "-i", type=str, required=True, help="dir to image files")
    ...
    for image_path in os.listdir(image_dir):
        image_pil, image = load_image(os.path.join(image_dir, image_path))
        ...
        plot_on_image(image_pil, pred_dict,keypoint_skeleton,keypoint_text_prompt,output_dir, image_path)
